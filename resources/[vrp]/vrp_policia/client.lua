...
Citizen.CreateThread(function()
	while true do 
		local distance1 = GetDistanceBetweenCoords(GetEntityCoords(PlayerPedId()),629.37,-6.14,82.78,true)
		local distance2 = GetDistanceBetweenCoords(GetEntityCoords(PlayerPedId()),568.52,4.81,103.24,true)
	   	if distance1 <= 3.0 then
			print("AAA")
			DrawMarker(21,629.37,-6.14,82.78,0,0,0,0,0,0,0.5,0.5,0.5,255,255,255,150,1,0,0,1)
			if IsControlJustPressed(1,38) then
				vRP.teleport(568.52,4.81,103.24)
			end
		end
		if distance2 <= 3.0 then
			DrawMarker(21,568.52,4.81,103.24,0,0,0,0,0,0,0.5,0.5,0.5,255,255,255,150,1,0,0,1)
			if IsControlJustPressed(1,38) then
				vRP.teleport(629.37,-6.14,82.78)
			end
		end
		Citizen.Wait(1)
	end
