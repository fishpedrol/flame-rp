...
local garages = {
	...
	[27] = { ['name'] = "Garagem", ['payment'] = true, ['public'] = true },
	...
	[44] = { ['name'] = "Garagem", ['payment'] = true, ['public'] = true },
	[55] = { ['name'] = "Concessionaria", ['payment'] = false, ['public'] = true },
	[57] = { ['name'] = "PoliciaH", ['payment'] = false, ['perm'] = "policia.permissao" },
	[58] = { ['name'] = "Bicicletario", ['payment'] = true, ['perm'] = "livre" },
	[62] = { ['name'] = "Policia", ['payment'] = false, ['perm'] = "policia.permissao" },
	[63] = { ['name'] = "Policia", ['payment'] = false, ['perm'] = "policia.permissao" },
	[64] = { ['name'] = "Policia", ['payment'] = false, ['perm'] = "policia.permissao" },
	[65] = { ['name'] = "Policia", ['payment'] = false, ['perm'] = "policia.permissao" },
	[66] = { ['name'] = "PoliciaB", ['payment'] = false, ['perm'] = "policia.permissao" },
	[67] = { ['name'] = "PoliciaH", ['payment'] = false, ['perm'] = "policia.permissao" },
	[68] = { ['name'] = "PoliciaA", ['payment'] = false, ['perm'] = "policia.permissao" },
	[69] = { ['name'] = "Garagem", ['payment'] = true, ['perm'] = "livre" },
	[70] = { ['name'] = "Mecanico", ['payment'] = true, ['perm'] = "mecanico.permissao" },
	[71] = { ['name'] = "Garagem", ['payment'] = true, ['perm'] = "livre" },
-----------------------------------------------------------------------------------------------------------------------------------------
---------------------------------------------------------FORTHILLS-----------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------------------------------------------------------
	...
	[613] = { ['name'] = "MS06", ['payment'] = false, ['public'] = false },
	[605] = { ['name'] = "MS09", ['payment'] = false, ['public'] = false },
	[606] = { ['name'] = "SS01", ['payment'] = false, ['public'] = false },

	[607] = { ['name'] = "MS08", ['payment'] = false, ['public'] = false },

	[608] = { ['name'] = "Garagem", ['payment'] = true, ['public'] = true },
	[609] = { ['name'] = "FZ01", ['payment'] = false, ['public'] = false },
	[610] = { ['name'] = "BMX", ['payment'] = true, ['perm'] = "livre" },
	[611] = { ['name'] = "Garagem", ['payment'] = true, ['public'] = true },
	[612] = { ['name'] = "Garagem", ['payment'] = true, ['public'] = true },
	[613] = { ['name'] = "Garagem", ['payment'] = true, ['public'] = true },
	[614] = { ['name'] = "Garagem", ['payment'] = true, ['public'] = true },
	[615] = { ['name'] = "Garagem", ['payment'] = true, ['public'] = true },
	[616] = { ['name'] = "Garagem", ['payment'] = true, ['public'] = true },
	[617] = { ['name'] = "Garagem", ['payment'] = true, ['public'] = true },
	[618] = { ['name'] = "Garagem", ['payment'] = true, ['public'] = true },
	[619] = { ['name'] = "Garagem", ['payment'] = true, ['public'] = true },
	[620] = { ['name'] = "Garagem", ['payment'] = true, ['public'] = true },
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- GARAGEMS
-----------------------------------------------------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------------------------------------------------------
-- PEGANDO OTARIOS COM EVENTO TRIGGADOKKKKKKKKKKKKKKK
-----------------------------------------------------------------------------------------------------------------------------------------
...
AddEventHandler("desmancheVehicles",function()
	...
	if user_id then
		...
		SendWebhookMessage(webhooktrigger,"```prolog\n[ID]: "..user_id.." "..identity.name.." "..identity.firstname.." \n[MOTIVO]: TENTOU DAR TRIGGER EM EVENTO DE DESMANCHE"..os.date("\n[Data]: %d/%m/%Y [Hora]: %H:%M:%S").." \r```")
		vRP.kick(source,"Você foi expulso do servidor.")
			local adminDisplay = vRP.getUsersByPermission("staff.permissao")
			for l,w in pairs(adminDisplay) do
				local adminSource = vRP.getUserSource(parseInt(w))
				if adminSource then
					async(function()
						TriggerClientEvent('chatMessage',adminSource,"[AntiCheat] ("..user_id..") "..identity.name.." "..identity.firstname.." tentou desmanchar um veículo com cheat.",{255, 179, 255})
						TriggerClientEvent('chatMessage',adminSource,"[AntiCheat] ("..user_id..") "..identity.name.." "..identity.firstname.." foi punido pelo neAntiCheat.",{255, 179, 255})
				end) 
			end
		end
	end
							...
							if garages[use].payment then
								...
								if (vRP.getBankMoney(user_id)+vRP.getMoney(user_id)) >= parseInt(vRP.vehiclePrice(name)*0.005 and not vRP.vehicleType(tostring(name)) == "exclusive" or vRP.vehicleType(tostring(name)) == "rental") then
									...
									if spawnveh and vRP.tryFullPayment(user_id,parseInt(vRP.vehiclePrice(name)*0.005)) then
										vehlist[vehid] = { parseInt(user_id),name }
										TriggerEvent("setPlateEveryone",identity.registration)
										TriggerClientEvent("Notify",source,"financeiro","Você pagou <b>$"..vRP.format(parseInt(vRP.vehiclePrice(name)*0.005)).." dólares</b>, da taxa de liberação.",10000)
									end
								else
									TriggerClientEvent("Notify",source,"negado","Dinheiro insuficiente.",10000)
								end
	...
	if user_id then
		...
		if vehicle and placa then
			...
			if puser_id then
				...
				vRP.giveInventoryItem(user_id,"dinheirosujo",parseInt(vRP.vehiclePrice(vname)*0.3))
				vCLIENT.deleteVehicle(source,vehicle)
				local identity = vRP.getUserIdentity(user_id)
...
RegisterCommand('dv',function(source,args,rawCommand)
	local user_id = vRP.getUserId(source)
	if vRP.hasPermission(user_id,"adm.permissao") or vRP.hasPermission(user_id,"mecanico.permissao") or vRP.hasPermission(user_id,"suporte.permissao") then
			...
			if math.random(500) >= 100 then
				...
				for k,v in pairs(policia) do
					...
					if player then
						async(function()
							local id = idgens:gen()
							TriggerClientEvent('chatMessage',player,"Dispatch",{64,130,255},"Roubo na ^1"..street.."^0 do veículo ^1"..model.."^0 de placa ^1"..placa.."^0 verifique o ocorrido.")
	...
	if user_id then
		if args[1] and parseInt(args[2]) > 0 then
			...
			if myvehicles[1] then
				if vRP.vehicleType(tostring(args[1])) == "exclusive" or vRP.vehicleType(tostring(args[1])) == "rental" and not vRP.hasPermission(user_id,"adm.permissao") then
...
function src.CheckLiveryPermission()
	local source = source
	local user_id = vRP.getUserId(source)
	return vRP.hasPermission(user_id,"adm.permissao") 
end
-----------------------------------------------------------------------------------------------------------------------------------------
-- HASH
-----------------------------------------------------------------------------------------------------------------------------------------
