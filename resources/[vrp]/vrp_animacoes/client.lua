...
local animacoes = {
	...
	{ nome = "dancar254" , dict = "anim@amb@nightclub@lazlow@hi_dancefloor@" , anim = "dancecrowd_li_15_handup_laz" , prop = "ba_prop_battle_hobby_horse" , flag = 50 , hand = 28422 , andar = false , loop = true },
	{ nome = "dancar255" , dict = "anim@amb@nightclub@lazlow@hi_dancefloor@" , anim = "crowddance_hi_11_handup_laz" , prop = "ba_prop_battle_hobby_horse" , flag = 50 , hand = 28422 , andar = false , loop = true },
	{ nome = "dancar256" , dict = "anim@amb@nightclub@lazlow@hi_dancefloor@" , anim = "dancecrowd_li_11_hu_shimmy_laz" , prop = "ba_prop_battle_hobby_horse" , flag = 50 , hand = 28422 , andar = false , loop = true },
