...
AddEventHandler('fuel:startFuelUpTick',function(pumpObject,ped,vehicle)
	...
	while isFueling do
		...
		local fuelToAdd = math.random(3,9) / 100.0
	...
	if pumpObject then
		TriggerServerEvent('vrp_legacyfuel:pagamento5',parseInt(currentCost),false,VehToNet(vehicle),GetVehicleFuelLevel(vehicle),currentFuel2)
	end

	currentCost = 0.0
end)

RegisterNetEvent("vrp_legacyfuel:insuficiente5")
AddEventHandler("vrp_legacyfuel:insuficiente5",function(index,fuel)
...
RegisterNetEvent('vrp_legacyfuel:galao5')
AddEventHandler('vrp_legacyfuel:galao5',function()
