...
policia = Tunnel.getInterface("emp_policia")
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIAVEIS
-----------------------------------------------------------------------------------------------------------------------------------------
local blips = false
...
local coordenadas = {
	{ ['id'] = 1, ['x'] = 625.17, ['y'] = -16.24, ['z'] = 87.82},
	{ ['id'] = 2, ['x'] = 621.42, ['y'] = -26.41, ['z'] = 87.82 },
	{ ['id'] = 3, ['x'] = 617.86, ['y'] = -28.72, ['z'] = 87.82 },
		...
		if servico then
			...
			if distance <= 30.0 then
				...
				if distance <= 4.5 then
					if policia.checkPermission() then
						if IsVehicleModel(GetVehiclePedIsUsing(PlayerPedId()),GetHashKey("vra3")) or
							...
							if IsPedInAnyVehicle(ped) then
								...
								if speed <= 100	then
									policia.IcyuiAAvgbU5sDX(pagamento)
