...
function isDead()
	if IsPlayerDead(PlayerId()) or GetEntityHealth(PlayerPedId()) <= 101 or LocalPlayer.state.isDead then
		return true
	end
end
	...
	if not radioPressed and radioEnabled then
		if radioChannel > 0 then
			...
			Citizen.CreateThread(function()
				...
				while radioPressed and GetEntityHealth(PlayerPedId()) > 101 do
					Wait(0)
...
if gameVersion == 'fivem' then
	RegisterKeyMapping('+radiotalk', '[BARNEY] Talk over Radio', 'keyboard', GetConvar('voice_defaultRadio', 'LMENU'))
end
