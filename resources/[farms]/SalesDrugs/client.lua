...
src = Tunnel.getInterface("fsh_entrega")
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIAVEIS
-----------------------------------------------------------------------------------------------------------------------------------------
local blips = false
...
local PosEntregas = {
    [1] = {['x'] = -150.8, ['y'] = -1622.33, ['z'] = 33.66, ['CorBlipR'] = 0, ['CorBlipG'] = 255, ['CorBlipB'] = 0}, -- GROOVE
    [2] = {['x'] = 84.35, ['y'] = -1966.75, ['z'] = 20.94, ['CorBlipR'] = 134, ['CorBlipG'] = 52, ['CorBlipB'] = 235}, -- BALLAS
    [3] = {['x'] = 360.62, ['y'] = -2042.68, ['z'] = 22.36, ['CorBlipR'] = 255, ['CorBlipG'] = 255, ['CorBlipB'] = 0 }, -- VAGOS
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- RESIDENCIAS
-----------------------------------------------------------------------------------------------------------------------------------------
local locs = {
    [1] = {['x'] = -522.87, ['y'] = -602.5, ['z'] = 30.45},
    [2] = {['x'] = -813.42, ['y'] = -586.12, ['z'] = 30.67},
    [3] = {['x'] = -728.48, ['y'] = -879.87, ['z'] = 22.72},
    [4] = {['x'] = -664.29, ['y'] = -1218.27, ['z'] = 11.82},
		...
		if not servico then
			for _, InfoEntregas in pairs(PosEntregas) do
				...
				if distance <= 5.0 then
					sleep = 5
					DrawMarker(21, InfoEntregas.x, InfoEntregas.y, InfoEntregas.z-1, 0, 0, 0, 0, 0, 0,1.0, 1.0, 1.0, InfoEntregas.CorBlipR, InfoEntregas.CorBlipG, InfoEntregas.CorBlipB,55, 0, 0, 0, 1)
