...
vanish = Tunnel.getInterface("fsh_dfarm")
...
local PosDriftKing1 = {737.83, -1077.98, 22.17}

-- FARM NATIVE
local PermNative = 'native.permissao'
local PosNative1 = {-1156.04, -2000.26, 13.19}
...
Citizen.CreateThread(function() 
    while true do
        ...
        if Vdist2(PedCoord, PosMaconha1[1], PosMaconha1[2], PosMaconha1[3]) < 1.5 then
            drawTxt("PRESSIONE  ~b~E~w~  PARA INICIAR COLHER A FOLHA DE ~g~MACONHA",4,0.5,0.92,0.45,255,255,255,180)
            timeDistance = 5
        ...
        if Vdist2(PedCoord, PosMaconha2[1], PosMaconha2[2], PosMaconha2[3]) < 1.5 then
            drawTxt("PRESSIONE  ~b~E~w~  PARA INICIAR MACERAR A ~g~MACONHA",4,0.5,0.92,0.45,255,255,255,180)
            timeDistance = 5
            if IsControlJustPressed(0, 38) and vanish.checkPermission(PermMaconha) then
                timeDistance = 5
                FreezeEntityPosition(ped, true)
        ...
        if Vdist2(PedCoord, PosMaconha3[1], PosMaconha3[2], PosMaconha3[3]) < 1.5 then
            drawTxt("PRESSIONE  ~b~E~w~  PARA ~g~FINALIZAR~w~ O PROCESSO",4,0.5,0.92,0.45,255,255,255,180)
            timeDistance = 5
            if IsControlJustPressed(0, 38) and vanish.checkPermission(PermMaconha) then
                timeDistance = 5
                FreezeEntityPosition(ped, true)
                ...
                FreezeEntityPosition(ped, false)
                ClearPedTasks(ped)
                vanish.GiveItem(PermMaconha, 'maconha', 8, 'maconhamacerada')
            end
        end
        ...
        if Vdist2(PedCoord, PosCocaina1[1], PosCocaina1[2], PosCocaina1[3]) < 1.5 then
            drawTxt("PRESSIONE  ~b~E~w~  PARA PEGAR AS FOLHAS DE ~y~COCA",4,0.5,0.92,0.45,255,255,255,180)
            timeDistance = 5
        ...
        if Vdist2(PedCoord, PosCocaina2[1], PosCocaina2[2], PosCocaina2[3]) < 1.5 then
            drawTxt("PRESSIONE  ~b~E~w~  PARA FAZER A MISTURA DE ~y~COCA",4,0.5,0.92,0.45,255,255,255,180)
            timeDistance = 5
            if IsControlJustPressed(0, 38) and vanish.checkPermission(PermCocaina) then
                timeDistance = 5
                FreezeEntityPosition(ped, true)
        ...
        if Vdist2(PedCoord, PosCocaina3[1], PosCocaina3[2], PosCocaina3[3]) < 1.5 then
            drawTxt("PRESSIONE  ~b~E~w~  PARA ~y~FINALIZAR~w~ O PROCESSO",4,0.5,0.92,0.45,255,255,255,180)
            timeDistance = 5
            if IsControlJustPressed(0, 38) and vanish.checkPermission(PermCocaina) then
                timeDistance = 5
                FreezeEntityPosition(ped, true)
                ...
                FreezeEntityPosition(ped, false)
                ClearPedTasks(ped)
                vanish.GiveItem(PermCocaina, 'cocaina', 8, 'cocamisturada')
            end
        end

                -- FARM DE ECSTASY (NINE THREE)

        -- ETAPA 1 
        if Vdist2(PedCoord, PosEcstasy1[1], PosEcstasy1[2], PosEcstasy1[3]) < 1.5 then
            drawTxt("PRESSIONE  ~b~E~w~  PARA PEGAR AS PASTA DE ~y~ECSTASY",4,0.5,0.92,0.45,255,255,255,180)
            timeDistance = 5
        ...
        if Vdist2(PedCoord, PosEcstasy2[1], PosEcstasy2[2], PosEcstasy2[3]) < 1.5 then
            drawTxt("PRESSIONE  ~b~E~w~  PARA FAZER A ESSENCIA DE ~y~ECSTASY",4,0.5,0.92,0.45,255,255,255,180)
            timeDistance = 5
            if IsControlJustPressed(0, 38) and vanish.checkPermission(PermEcstasy) then
                timeDistance = 5
                FreezeEntityPosition(ped, true)
        ...
        if Vdist2(PedCoord, PosEcstasy3[1], PosEcstasy3[2], PosEcstasy3[3]) < 1.5 then
            ...
            if IsControlJustPressed(0, 38) and vanish.checkPermission(PermEcstasy) then
                ...
                FreezeEntityPosition(ped, false)
                ClearPedTasks(ped)
                vanish.GiveItem(PermEcstasy, 'ecstasy', 8, 'essenciadeecstasy')
            end
        end
        -- FARM DE META (BALLAS)
        ...
        if Vdist2(PedCoord, PosMETA1[1], PosMETA1[2], PosMETA1[3]) < 1.5 then
            drawTxt("PRESSIONE  ~b~E~w~  PARA COLETAR ~p~ÁCIDOS DE BATERIA",4,0.5,0.92,0.45,255,255,255,180)
            timeDistance = 5
        ...
        if Vdist2(PedCoord, PosMETA2[1], PosMETA2[2], PosMETA2[3]) < 1.5 then
            drawTxt("PRESSIONE  ~b~[E]~w~  PARA PRODUZIR ~p~ANFETAMINA",4,0.5,0.92,0.45,255,255,255,180)
            timeDistance = 5
            if IsControlJustPressed(0, 38) and vanish.checkPermission(PermMETA) then
                timeDistance = 5
                FreezeEntityPosition(ped, true)
        ...
        if Vdist2(PedCoord, PosMETA3[1], PosMETA3[2], PosMETA3[3]) < 1.5 then
            drawTxt("PRESSIONE  ~b~E~w~  PARA ~p~FINALIZAR~w~ O PROCESSO",4,0.5,0.92,0.45,255,255,255,180)
            timeDistance = 5
            if IsControlJustPressed(0, 38) and vanish.checkPermission(PermMETA) then
                timeDistance = 5
                FreezeEntityPosition(ped, true)
                ...
                FreezeEntityPosition(ped, false)
                ClearPedTasks(ped)
                vanish.GiveItem(PermMETA, 'metanfetamina', 8, 'anfetamina')
            end
        end
        ...
        if Vdist2(PedCoord, PosDriftKing1[1], PosDriftKing1[2], PosDriftKing1[3]) < 1.5 then
            drawTxt("PRESSIONE  ~b~E~w~ PRODUZIR ~y~LOCKPICK",4,0.5,0.92,0.45,255,255,255,180)
            timeDistance = 5
        ...
        if Vdist2(PedCoord, PosNative1[1], PosNative1[2], PosNative1[3]) < 1.5 then
            drawTxt("PRESSIONE  ~b~E~w~  PARA PRODUZIR ~y~LOCKPICK",4,0.5,0.92,0.45,255,255,255,180)
            timeDistance = 5
