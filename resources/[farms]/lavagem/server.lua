...
juan = {}
Tunnel.bindInterface("vrp_lavagem",juan)
local idgens = Tools.newIDGenerator()
local blips = {}
-----------------------------------------------------------------------------------------------------------------------------------------
-- CHECAR O PAGAMENTO
-----------------------------------------------------------------------------------------------------------------------------------------
function juan.ChecarPagamento()
	local source = source 
...
-----------------------------------------------------------------------------------------------------------------------------------------
function juan.VerificarComponente(componente,qcomponente)
	local source = source 
	local user_id = vRP.getUserId(source)
	if user_id then 
...
-----------------------------------------------------------------------------------------------------------------------------------------
function juan.EnviarPagamento(tipo)
    local source = source 
    local user_id = vRP.getUserId(source)
    if user_id then
...
-----------------------------------------------------------------------------------------------------------------------------------------
function juan.PermissaoPlayer(permissao)
	local source = source 
	local user_id = vRP.getUserId(source)
	if user_id then
